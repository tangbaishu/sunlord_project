 ...
 */
void Busi_Fast_Charge_Enable(config_data_t *config_data, bool protocol_enable)
{
	if(protocol_enable)
	{
...
Enable_Protocol:
    Busi_Fast_Charge_Enable(config_data, ENABLE);
    return;

Disable_Protocol:
    Busi_Fast_Charge_Enable(config_data, DISABLE);
    return;
}
