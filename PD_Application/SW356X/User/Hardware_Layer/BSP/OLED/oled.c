...
void OLED_WR_Byte(unsigned dat, unsigned cmd)
{
	...
	if (cmd)
	{
		I2C_M_Driver.Transfer_Data.Reg_Addr = OLED_DATA_REG;
		I2C_M_Driver.Transfer_Data.P_Wdata[0] = dat;
		I2C_M_Driver.Transfer_Data.Wdata_Len = 1;
		I2C_Master_Write_NByte(&I2C_M_Driver.Transfer_Data);
	}
	else
	{
		I2C_M_Driver.Transfer_Data.Reg_Addr = OLED_CMD_REG;
		I2C_M_Driver.Transfer_Data.P_Wdata[0] = dat;
		I2C_M_Driver.Transfer_Data.Wdata_Len = 1;
		I2C_Master_Write_NByte(&I2C_M_Driver.Transfer_Data);
	}
...
{
	printf("OLED_INIT\r\n");
	// I2C_Master_Driver_Init(OLED_DEVICE_ID);
